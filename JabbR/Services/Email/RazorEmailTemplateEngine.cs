...
namespace JabbR.Services
{
    public class RazorEmailTemplateEngine : IEmailTemplateEngine
    {
        ...
        private static Assembly GenerateAssembly(params KeyValuePair<string, string>[] templates)
        {
            ...
            {
                var parseExceptionMessage = String.Join(Environment.NewLine + Environment.NewLine, templateResults.SelectMany<GeneratorResults, ParserError>(r => r.ParserErrors).Select(e => e.Location + ":" + Environment.NewLine + e.Message).ToArray());
