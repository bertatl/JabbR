    ...
    public class JabbRModule : NancyModule
    {
        ...
        internal static void RemoveAlerts(NancyContext context)
        {
                ...
                context.Response.StatusCode != HttpStatusCode.Found)
            {
                ...
                context.Response.Cookies.Remove(Constants.AuthResultCookie);
                context.Response.Cookies.Add(new NancyCookie(Constants.AuthResultCookie, string.Empty, DateTime.Now.AddDays(-1)));
            }
        }
    }
}